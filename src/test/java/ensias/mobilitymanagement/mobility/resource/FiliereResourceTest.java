...
class FiliereResourceTest {
    ...
    void getAllFilieres() {
        ...
        filieres.add(new Filiere(2L, "Génie logiciel"));
    ...
    @Test
    void getFiliereById() {
        Filiere filiere = new Filiere(1L, "Génie logiciel");
    ...
    @Test
    void addFiliere() {
        Filiere filiereToAdd = new Filiere(1L, "Génie logiciel");
        Filiere addedFiliere = new Filiere(1L, "Génie logiciel");
    ...
    @Test
    void updateFiliere() {
        Filiere filiereToUpdate = new Filiere(1L, "Génie logiciel");
